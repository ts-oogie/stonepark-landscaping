...
var ContactView = Backbone.View.extend({
    ...
    template: _.template(
        '<div id="contact-view">' +  
            '<div id="contact-info">' + 
                '<form method="POST" id="contact-f" enctype="multipart/form-data" action="https://beautify-stonepark-f8af732df93d.herokuapp.com/upload">' +
                '<p>' + 
                ...
                '<p>' +  //Input Button - design
                    ...
                    '<label for="design">Installation</label><br>' + 
                '<p>' + 
                ...
                '<p>' + 
                '<p>' +  //Input button - trim
                    '<input type="radio" id="trim" class="contact-radio-text" name="trim" value="Trim"></input>' + 
                    '<label for="trim">Trim</label><br>' + 
                '<p>' + 
                '<p>' +  //Input button - soil
                    '<input type="radio" id="soil" class="contact-radio-text" name="soil" value="Soil"></input>' + 
                    '<label for="soil">Soil Erosion</label><br>' + 
                '<p>' + 
